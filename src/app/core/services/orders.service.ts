...
// import {OrdersModel} from '../../pages/ecommerce/orders/orders.model';
// import {Orders} from '../../pages/ecommerce/orders/data';
// import {DecimalPipe} from '@angular/common';
// import {debounceTime, delay, switchMap, tap} from 'rxjs/operators';
// import {SortColumn, SortDirection} from '../../pages/ecommerce/orders/orders-sortable.directive';
...
function matches(country: OrdersModel, term: string) {
  return country.name.toLowerCase().includes(term.toLowerCase())
    || country.total.toLowerCase().includes(term.toLowerCase())
    || country.status.toLowerCase().includes(term.toLowerCase())
    || country.payment.toLowerCase().includes(term.toLowerCase());
...
export class OrdersService {
  ...
  private decimalPipe = new DatePipe('en-US');
