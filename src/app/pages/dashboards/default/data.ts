...
const receivedTimeChart: ChartType = {
  ...
  const pieChart: EChartsOption = {
    ...
    legend: {
        orient: 'vertical',
        left: 'left',
        data: ['Laptop', 'Tablet', 'Mobile', 'Desktop'],
...
export { jobViewChart, ApplicationChart, ApprovedChart, RejectedChart, emailSentBarChart, vacancyData, receivedTimeChart, recentJobsData, pieChart};
